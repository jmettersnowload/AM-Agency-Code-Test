...
function new_topic_taxonomy() {
	//add new taxonomies hierachical
	$labels = array(
		'name' => 'Topics',
		'singular_name' => 'Topic',
	...
	register_taxonomy('Topic', array('portfolio'), $args);
}

add_action('init', 'new_topic_taxonomy');


// audience

function new_audience_taxonomy() {
	//add new taxonomies hierachical
	$labels = array(
		'name' => 'Audience',
	...
	register_taxonomy('Audience', array('portfolio'), $args);
}

add_action('init', 'new_audience_taxonomy');
